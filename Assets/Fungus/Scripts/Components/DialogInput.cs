...
namespace Fungus
{
    ...
    public class DialogInput : MonoBehaviour
    {
        ...
        [SerializeField] protected ClickMode clickMode = ClickMode.Disabled;
        ...
        protected InputSystemUIInputModule currentInputModule;
        ...
        protected virtual void Awake()
        {
            ...
            currentInputModule = EventSystem.current.GetComponent<InputSystemUIInputModule>();
        }
        ...
        protected virtual void Update()
        {
            ...
            if (writer != null)
            {
                if (currentInputModule.submit.action.triggered)
                {
                    SetSubmitButtonFlag();
                }
            }
        ...
        /// </summary>
        public virtual void SetSubmitButtonFlag()
        {
            if (ignoreClickTimer > 0f)
            {
                return;
