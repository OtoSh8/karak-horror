...
namespace Fungus
{
    ...
    public class FadeToView : Command 
    {
        ...
        protected virtual void AcquireCamera()
        {
            ...
            if (targetCamera == null)
            {
                targetCamera = GameObject.FindAnyObjectByType<Camera>();
            }
        }
        ...
        public override void OnEnter()
        {
            ...
            cameraManager.FadeToView(currentCamera, targetCamera, targetView, duration, fadeOut, delegate { 
        ...
        public override string GetSummary()
        {
            ...
            {
                return "Camera to : " + targetView.name;
            }
        }
